...
TEST_F(MapperNSFTest, CpuAddressType) {
    ...
    for (int addr = 0x4020; addr <= 0x5FFF; ++addr) {
...
//
//TEST_F(MapperNSFTest, DefaultState) {
...
//}
//
//TEST_F(MapperNSFTest, MMC1_IgnoreConsecutiveWrites) {
//    FAIL();
//}
//
//TEST_F(MapperNSFTest, Mirroring_Single_Nametable0) {
...
//}
//
//TEST_F(MapperNSFTest, Mirroring_Single_Nametable1) {
...
//}
//
//TEST_F(MapperNSFTest, Mirroring_Horizontal) {
...
//}
//
//TEST_F(MapperNSFTest, Mirroring_Vertical) {
...
//}
//
//TEST_F(MapperNSFTest, MMC1_WriteToRegisters) {
//    // Control register
//    { // bits 00000 = 0x00
...
//}
//
//TEST_F(MapperNSFTest, MMC1_WriteIsAbove0x8000) {
//    EXPECT_EQ(Mapper_003::MMCRegister::None, mmc1.WriteToMMC1(0x8000, 0x00).Register);
//    EXPECT_EQ(Mapper_003::MMCRegister::None, mmc1.WriteToMMC1(0x8000, 0x00).Register);
//    EXPECT_EQ(Mapper_003::MMCRegister::None, mmc1.WriteToMMC1(0x8000, 0x00).Register);
//    EXPECT_EQ(Mapper_003::MMCRegister::None, mmc1.WriteToMMC1(0x8000, 0x00).Register);
...
//}
//
//TEST_F(MapperNSFTest, MMC1_OnlyLastWriteSelectsRegister) {
//    EXPECT_EQ(Mapper_003::MMCRegister::None, mmc1.WriteToMMC1(0xFFFF, 0x00).Register);
//    EXPECT_EQ(Mapper_003::MMCRegister::None, mmc1.WriteToMMC1(0xFFFF, 0x00).Register);
//    EXPECT_EQ(Mapper_003::MMCRegister::None, mmc1.WriteToMMC1(0xFFFF, 0x00).Register);
//    EXPECT_EQ(Mapper_003::MMCRegister::None, mmc1.WriteToMMC1(0xFFFF, 0x00).Register);
...
//}
//
//TEST_F(MapperNSFTest, MMC1_ResetWrite) {
...
//}
//
//TEST_F(MapperNSFTest, ControlRegister) {
//    mmc1.WriteControl(0x00);
...
//}
//
//TEST_F(MapperNSFTest, CHR0Register) {
...
//}
//
//TEST_F(MapperNSFTest, CHR1Register) {
//    // Include mirroring for banks too high
...
//}
//
//TEST_F(MapperNSFTest, PRGRegister) {
//    // Include mirroring for banks too high
...
//}
//
//TEST_F(MapperNSFTest, CHR_8KBanks) {
//    mmc1.ChrMode = Mapper_003::CHRBankingMode::OneBank;
//    
...
//}
//
//TEST_F(MapperNSFTest, CHR_4KBanks) {
//    mmc1.ChrMode = Mapper_003::CHRBankingMode::TwoBanks;
//
//    mmc1.ChrBank0 = 0;
//    mmc1.ChrBank1 = 1;
...
//}
//
//TEST_F(MapperNSFTest, PRG_16KBanks_FirstBank) {
...
//}
//
//TEST_F(MapperNSFTest, PRG_16KBanks_LastBank) {
...
//}
//
//TEST_F(MapperNSFTest, PRG_IsROM) {
//    const auto b = mmc1.GetCpuAt(0x8000);
//    mmc1.SetCpuAt(0x8000, b + 1);
//    EXPECT_EQ(b, mmc1.GetCpuAt(0x8000));
//}
//
//TEST_F(MapperNSFTest, LivePRGModeChange) {
//    FAIL();
//}
//
//TEST_F(MapperNSFTest, LiveCHRModeChange) {
//    FAIL();
//}
//
//TEST_F(MapperNSFTest, PRG_RAM) {
//    // Enabled
//    mmc1.WritePRG(0x00);
//    EXPECT_TRUE(mmc1.HasPrgRam);
...
//}
//
//TEST_F(MapperNSFTest, OtherMMC1Versions) {
//    FAIL();
//}
//
//TEST_F(MapperNSFTest, NoChrMeansChrRam) {
